...
export const ABOUT = {
  ...
  paragraphs: [
    ...
    "My favorite part of being a sofware engineer is translating complex customer requirements into scalable software. Over the years, I've learned how to architect a system that grows with the business as requirements change.",
  ],
};
